    ...
    <button className="BarsSmall w-8 h-8 relative cursor-pointer">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-5 h-5 rounded-full flex flex-col items-center justify-center">
          <div className="w-5 h-0.5 bg-white rounded" style={{ marginTop: '7px'}}></div>
          <div className="w-5 h-0.5 bg-white rounded" style={{ marginTop: '2px'}}></div>
          <div className="h-0.5 bg-white rounded" style={{ marginTop: '2px', alignSelf: 'start', width: '8px' }}></div>
          <div className="h-0.5 bg-white rounded" style={{ marginTop: '2px', alignSelf: 'start', width: '8px' }}></div>
        </div>
      </div>
    </button>
...
export const BarsWatchAgain = () => {
  return (
      <div className="inline">
          <BarsSmallMultiple />
          <div className="absolute bottom-0 right-0" style={{ transform: 'scale(0.8)'}}>
            <WatchAgainIcon />
          </div>
      </div>
  )
