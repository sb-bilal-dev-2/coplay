        ...
        {!authPage &&
          <>
            ...
            <div className="user-menu" onClick={handleNavMenuToggle}>
              {loggedIn ?
                <UserNav setIsNavMenuVisible={setIsNavMenuVisible} isNavMenuVisible={isNavMenuVisible} />
...
const UserNav = ({ isNavMenuVisible, setIsNavMenuVisible }) => {
  ...
  const firstLetter = !!emailLetters?.length && emailLetters[0]?.toUpperCase() || '';
  ...
  return (
    <>
      <img class="h-8 ml-4" src={`https://placehold.co/32x32.png?text=${firstLetter}&bg=8b8b8b`} alt="User avatar placeholder" />
      {isNavMenuVisible && <ul className="nav-menu" ref={outsideNavClickWrapperRef}>
